...
#include "P0_GameplayEffectTypes.generated.h"
 ...
 */
USTRUCT()
struct PROJECT0_API FP0_GameplayEffectContext : public FGameplayEffectContext
{
...
public:
	...
	*/
	...
	{
		return FP0_GameplayEffectContext::StaticStruct();
	}

	virtual FP0_GameplayEffectContext* Duplicate() const override
	{
		FP0_GameplayEffectContext* NewContext = new FP0_GameplayEffectContext();
		*NewContext = *this;
...
template<>
struct TStructOpsTypeTraits<FP0_GameplayEffectContext> : public TStructOpsTypeTraitsBase2<FP0_GameplayEffectContext>
{
	enum
	{
