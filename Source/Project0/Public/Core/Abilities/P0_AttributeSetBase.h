...
#include "P0_AttributeSetBase.generated.h"

/**
 * Base AttributeSet class to handle attributes such as Health, Shield, Stamina, etc.
 */
UCLASS()
class PROJECT0_API UP0_AttributeSetBase : public UAttributeSet
{
	GENERATED_BODY()

public:
	UP0_AttributeSetBase();
	...
	ATTRIBUTE_ACCESSORS(UP0_AttributeSetBase, Health);
