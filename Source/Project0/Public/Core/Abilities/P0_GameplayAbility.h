...
#include "P0_GameplayAbility.generated.h"

class AP0_Character;
class AP0_PlayerController;
 ...
 */
UCLASS()
class PROJECT0_API UP0_GameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	UP0_AbilitySystemComponent* GetP0AbilitySystemComponentFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "Project0|Ability")
	AP0_PlayerController* GetP0PlayerControllerFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "Project0|Ability")
	AController* GetControllerFromActorInfo() const;

	UFUNCTION(BlueprintCallable, Category = "Project0|Ability")
	AP0_Character* GetP0CharacterFromActorInfo() const;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Ability")
	static UP0_GameplayAbility* GetPrimaryAbilityInstanceFromHandle(UAbilitySystemComponent* AbilitySystemComponent,
	                                                                FGameplayAbilitySpecHandle Handle);

	UFUNCTION(BlueprintCallable, Category = "Ability")
	static UP0_GameplayAbility* GetPrimaryAbilityInstanceFromClass(UAbilitySystemComponent* AbilitySystemComponent,
