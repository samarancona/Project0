...
#include "P0_AbilitySystemComponent.generated.h"


DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FReceivedDamageDelegate, UP0_AbilitySystemComponent*, SourceASC, float,
                                               UnmitigatedDamage, float, MitigatedDamage);

/** Delegate for when an effect is applied */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnGameplayEffectDurationChanged, UP0_AbilitySystemComponent*, const FActiveGameplayEffect&);
 ...
 */
UCLASS()
class PROJECT0_API UP0_AbilitySystemComponent : public UAbilitySystemComponent
{
	GENERATED_BODY()

public:
	UP0_AbilitySystemComponent();
	...
	virtual void ReceiveDamage(UP0_AbilitySystemComponent* SourceASC, float UnmitigatedDamage, float MitigatedDamage);
