...
class UP0_InputConfig;

UP0_InputComponent::UP0_InputComponent(const FObjectInitializer& ObjectInitializer)
{
}

void UP0_InputComponent::AddInputMappings(const UP0_InputConfig* InputConfig, UEnhancedInputLocalPlayerSubsystem* InputSubsystem) const
{
	/*
	check(InputConfig);
...
void UP0_InputComponent::RemoveInputMappings(const UP0_InputConfig* InputConfig, UEnhancedInputLocalPlayerSubsystem* InputSubsystem) const
{
	/*
	check(InputConfig);
	check(InputSubsystem);
...
void UP0_InputComponent::RemoveBinds(TArray<uint32>& BindHandles)
{
